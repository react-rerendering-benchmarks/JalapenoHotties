...
function UserReview(props) {
  ...
  const unsorted_list = all_reviews.map(review_1 => <div className='review'>
  ...
  const high_low_list = high_low.map(review_2 => <div className='review'>
  ...
  const low_high_list = low_high.map(review_3 => <div className='review'>
  ...
  const recent_list = recent.map(review_4 => <div className='review'>
  ...
  const old_list = old.map(review_5 => <div className='review'>
  ...
  return <div className="review-body">
            ...
            <button className='review-sort-buttons' onClick={() => {
        ...
        {isHighLow && <div>{high_low_list}</div>}
        {isLowHigh && <div>{low_high_list}</div>}
        {isUnsorted && <div>{unsorted_list}</div>}
        {isRecent && <div>{recent_list}</div>}
        {isOld && <div>{old_list}</div>}
